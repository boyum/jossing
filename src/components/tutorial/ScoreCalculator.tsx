...
export default function ScoreCalculator() {
	const [selectedExample, setSelectedExample] = useState<ScoreExample>(
		scoreExamples[0],
	);
	...
	return (
		<div className="bg-white rounded-lg shadow-md p-6">
			...
			<p className="text-gray-600 mb-6">
				Understanding how scoring works is key to strategic bidding. Try
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-2">
						{scoreExamples.map((example) => (
							...
							>
								...
								<div
									className={`text-sm ${selectedExample.id === example.id ? "text-blue-100" : "text-gray-600"}`}
								>
				...
				<div className="space-y-3">
					...
					<div className="flex justify-between items-center">
						...
						<span className="font-mono">
							{currentTricks === currentBid ? "Yes" : "No"}
						</span>
					</div>
					...
					<div className="flex justify-between items-center">
						...
						<span className="font-mono text-sm">
							{currentTricks === currentBid
								? `10 + ${currentBid} = ${currentScore.finalScore}`
								: "0"}
						</span>
					</div>
					...
					<div className="flex justify-between items-center font-bold text-lg">
						...
						<span
							className={`font-mono ${currentScore.finalScore >= 0 ? "text-green-600" : "text-red-600"}`}
						>
