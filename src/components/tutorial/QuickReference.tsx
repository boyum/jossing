				...
				<div className="space-y-4">
					<div className="bg-green-50 p-3 rounded">
						<h4 className="font-medium text-green-800 mb-2">
							Classic Jøssing Scoring
						</h4>
						<ul className="text-sm space-y-1">
							<li>
								<strong>Exact bid:</strong> 10 + bid points
							</li>
							<li>
								<strong>Any other result:</strong> 0 points
							</li>
							<li>
								<strong>Simple rule:</strong> Hit your bid exactly or get
								nothing!
							</li>
						</ul>
					</div>
				...
				<div className="space-y-4">
					...
					<div className="bg-red-50 p-3 rounded">
						...
						<div className="text-sm">
							<div>
								<strong>Trump Suit:</strong> A, K, Q, J, 10, 9, 8, 7, 6, 5, 4,
								3, 2
							</div>
							<div>
								<strong>Other Suits:</strong> A, K, Q, J, 10, 9, 8, 7, 6, 5, 4,
								3, 2
							</div>
				...
				<div className="space-y-4">
					...
					<div className="bg-orange-50 p-3 rounded">
						...
						<ul className="text-sm space-y-1 list-disc list-inside">
							...
							<li>
								Bid based only on your hand - you can&apos;t see others&apos;
								bids
							</li>
							<li>Zero bids are risky but can pay off</li>
							<li>
								Remember: being exact is more important than winning lots of
								tricks
							</li>
						</ul>
					</div>
				...
				<div className="space-y-4">
					<div className="bg-indigo-50 p-3 rounded">
						...
						<div className="text-sm space-y-2">
							<div>
								<strong>Up Game:</strong> Sections 1, 2, 3, 4, 5, 6, 7
							</div>
							<div>
								<strong>Up-and-Down:</strong> 1, 2, 3, 4, 5, 6, 7, 6, 5, 4, 3,
								2, 1
							</div>
					...
					<div className="bg-gray-50 p-3 rounded">
						...
						<ol className="text-sm space-y-1 list-decimal list-inside">
							<li>
								<strong>Deal:</strong> Give each player section number of cards
							</li>
							<li>
								<strong>Trump:</strong> Randomly select trump suit
							</li>
							<li>
								<strong>Bid:</strong> Players predict their tricks
							</li>
							<li>
								<strong>Play:</strong> Play all tricks
							</li>
							<li>
								<strong>Score:</strong> Award points based on accuracy
							</li>
							<li>
								<strong>Next:</strong> Move to next section
							</li>
						</ol>
					</div>
				</div>
