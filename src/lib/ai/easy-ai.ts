...
export class EasyAI extends BaseAI {
   ...
   */
  makeBid(hand: Card[], maxBid: number, trumpSuit: Suit, _position: number, _opponentBids: number[]): number {
  ...
  playCard(hand: Card[], currentTrick: Card[], trumpSuit: Suit, leadingSuit?: Suit, gameContext?: GameContext): Card {
    ...
    if (shouldTryToWin) {
      return this.tryToWinTrick(validCards, currentTrick, trumpSuit, leadingSuit);
    } else {
      return this.tryToLoseTrick(validCards, currentTrick, trumpSuit, leadingSuit);
    }
  }
   ...
   */
  private leadTrick(validCards: Card[], trumpSuit: Suit, _gameContext?: GameContext): Card {
   ...
   */
  private tryToWinTrick(validCards: Card[], currentTrick: Card[], trumpSuit: Suit, leadingSuit?: Suit): Card {
   ...
   */
  private tryToLoseTrick(validCards: Card[], currentTrick: Card[], trumpSuit: Suit, leadingSuit?: Suit): Card {
